...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.loginCard.setGeometry(QRect(210, 49, 400, 431))
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ConfirmPasswordLineEdit.setPlaceholderText(QCoreApplication.translate("Dialog", u"Enter your password", None))
    # retranslateUi
